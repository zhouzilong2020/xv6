...
found:
  ...
  // TRAMPOLINE is mapped by assembly?
...
pagetable_t proc_pagetable(struct proc *p) {
  ...
  if (mappages(pagetable, TRAMPOLINE, PGSIZE,
               (uint64)trampoline /* pa for shared trampoline */,
               PTE_R | PTE_X) < 0) {
    uvmfree(pagetable, 0);
    return 0;
  }
  ...
  // trampoline.S.
  if (mappages(pagetable, TRAPFRAME /* right beneath trampoline */, PGSIZE,
  ...
  if (mappages(pagetable, USYSCALL /* right beneath trampoline */, PGSIZE,
